...
const WALLET_TOOLS = [
  ...
  "eusdc_rotation_scan",
  "eusdc_rotation_propose_entry",
  "eusdc_rotation_execute_entry",
  "eusdc_rotation_position_status",
  "eusdc_rotation_propose_exit",
  "eusdc_rotation_execute_exit",
  "execute_agent_tx",
  "sign_and_send",
...
describe("smoke: tool registration (no live network)", () => {
  it("registerAllTools registers full verification inventory", () => {
    ...
    // 110 tools: prior inventory + six guarded rotation tools + two read-only history tools.
    ...
    expect(WALLET_TOOLS).toHaveLength(23);
