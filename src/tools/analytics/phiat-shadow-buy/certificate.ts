...
export function buildCertificate(args: {
  ...
  return {
    ...
    manifestAuthorizationStatus: (args.executionLayer ?? emptyExecutionLayer()).manifestAuthorizationStatus,
    liveExecutionAuthorityStatus: (args.executionLayer ?? emptyExecutionLayer()).liveExecutionAuthorityStatus,
    executionAuthority: (args.executionLayer ?? emptyExecutionLayer()).executionAuthority,
...
export function emptyExecutionLayer(): ExecutionLayerCertification {
  return {
    ...
    statePrerequisites: {
      inputBalanceRequiredRaw: "0",
      inputBalanceAvailableRaw: null,
      allowanceRequiredRaw: "0",
      allowanceAvailableRaw: null,
      nativeGasRequiredWei: null,
      nativeGasAvailableWei: null,
    },
